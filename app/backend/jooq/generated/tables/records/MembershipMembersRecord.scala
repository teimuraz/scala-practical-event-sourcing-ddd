...
class MembershipMembersRecord extends UpdatableRecordImpl[MembershipMembersRecord](MembershipMembers.MEMBERSHIP_MEMBERS) with Record6[Long, String, String, Integer, Long, DateTime] {
  ...
  /**
   * Setter for <code>public.membership_members.organization_id</code>.
   */
  ...
  /**
   * Getter for <code>public.membership_members.organization_id</code>.
   */
  ...
  override def field5 : Field[Long] = MembershipMembers.MEMBERSHIP_MEMBERS.ORGANIZATION_ID
  override def field6 : Field[DateTime] = MembershipMembers.MEMBERSHIP_MEMBERS.BECAME_MEMBER_AT
  ...
  override def value5(value : Long) : MembershipMembersRecord = {
    setOrganizationId(value)
    this
  }

  override def value6(value : DateTime) : MembershipMembersRecord = {
    setBecameMemberAt(value)
    this
  }

  override def values(value1 : Long, value2 : String, value3 : String, value4 : Integer, value5 : Long, value6 : DateTime) : MembershipMembersRecord = {
    this.value1(value1)
    this.value2(value2)
    this.value3(value3)
    this.value4(value4)
